...
void test_rbtADD_given_root_is_null_new_node_should_become_red_color_root(void){
  ...
  testAssertNode(5, ((void *)0), ((void *)0), RED, &node5, 325);;
...
void test_rbtADD_given_added_new_node_larger_than_root_and_righ_child_should_place_at_right(void){
  ...
  testAssertNode(5, ((void *)0), ((void *)0), BLACK, &node5, 350);;

  testAssertNode(150, ((void *)0), ((void *)0), RED, &node150, 351);;

  testAssertNode(100, ((void *)0), &node150, BLACK, &node100, 352);;

  testAssertNode(50, &node5, &node100, BLACK, &node50, 353);;
